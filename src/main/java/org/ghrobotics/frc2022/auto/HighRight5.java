...
public class HighRight5 extends SequentialCommandGroup {
  /**
   * Shoots 5 balls into the high goal.
   *
   ...
   */
  public HighRight5(RobotState robot_state, Drivetrain drivetrain,
    ...
    addCommands(
        ...
        // Set shooter rpm and hood angle hint.
        new InstantCommand(
            () -> superstructure.setHint(AutoConfig.kHPToIntermediateB.sample(100).poseMeters)),

        // Pick up 4th and 5th ball.
        new DriveTrajectory(drivetrain, robot_state, AutoConfig.kMiddleCargoToHP),
        new DriveTrajectory(drivetrain, robot_state, AutoConfig.kHPToIntermediateB),
