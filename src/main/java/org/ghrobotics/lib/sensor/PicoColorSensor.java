package org.ghrobotics.lib.sensor;
...
/**
 * Library for interfacing with the REV Color Sensor that is connected to a Raspberry Pi Pico
 * which communicates with the roboRIO over serial.
 * <p>
 * From https://github.com/ThadHouse/picocolorsensor
 */
